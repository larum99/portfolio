    ...
    items: [
        {
            ...
            degre: "Técnico Laboral como Asistente en Desarrollo de Software",
            duration: "Actualmente",
        },
        {
            institution: "Google - Coursera",
            degre: "Análisis de Datos",
            duration: "2024",
        },
        {
            institution: "Google - Coursera",
            degre: "Ciberseguridad",
            duration: "2024",
        },
        {
            institution: "Universidad Autonoma de Occidente",
            degre: "Ingeniera Mecatrónica",
            duration: "2017 - 2023",
        },
    ]
}
            ...
            <div className="container mx-auto">
                <Tabs
                    ...
                    <TabsList className="flex flex-col w-full max-w-[380px] mx-auto xl:mx-0 gap-6">
                        ...
                        <TabsTrigger value="skills">Habillidades</TabsTrigger>
                    </TabsList>
                                    ...
                                    <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                                        {education.items.map((item, index) => {
                                            return (
                                                <li
                                                key={index}
                                                className="bg-[#27272c] h-auto py-6 px-10 rounded-xl flex flex-col justify-center items-center lg:items-start gep-1">
